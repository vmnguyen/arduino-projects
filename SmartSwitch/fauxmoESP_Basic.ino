...
#define ID_YELLOW           "light one"
#define ID_GREEN            "light two"
#define ID_BLUE             "light three"
#define ID_PINK             "light four"
#define ID_WHITE            "light five"
